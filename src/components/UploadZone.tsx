  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      ...
      >
        ...
        `}>
          <svg
            className={`w-10 h-10 transition-colors duration-200 ${isDragging ? 'text-indigo-400' : 'text-gray-400'}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-gray-600">
          ...
          <span className="px-2 py-1 rounded bg-gray-800">MKV</span>
          <span className="px-2 py-1 rounded bg-gray-800">WebM</span>
          <span className="px-2 py-1 rounded bg-gray-800">AVI</span>
          <span className="mx-1 text-gray-700">·</span>
          <span className="text-gray-600">Max 1 GB</span>
        </div>
